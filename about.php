...
<html lang="en">
  <head>
    ...
    <title>BSMS | About us Page</title>
...
<script>
    //if clicks the button then noscroll
$(function () {
...
//Execute the query and store the result in $ret
$ret=mysqli_query($con,"select * from tblpage where PageType='aboutus' ");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
// fetches each row as an associative array and displays pagetitle or description
