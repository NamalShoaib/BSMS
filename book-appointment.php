...
//checks the length of the value stored in bpmsuid if empty then go to logout page
...
//you're retrieving only the latest record from the table based on the ID column.
$result=mysqli_fetch_array($ret);
//assigns the value of the AptNumber column from the latest appointment record to the session variable $_SESSION['aptno']
...
<html lang="en">
  <head>
    ...
    <title>BSMS | Appointment Page</title>
