...
error_reporting(0);
// action canbe performed when click on submit button
...
//if email or mobile number already exists in the database
    $ret=mysqli_query($con, "select Email from tbluser where Email='$email' || MobileNumber='$contno'");
    //fetches the result into an array
...
<script type="text/javascript">
    //if pasword and repeat password are same then checkpass function execute
function checkpass()
{
